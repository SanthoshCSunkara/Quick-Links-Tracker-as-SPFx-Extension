...
import type { _ISearchData } from '@microsoft/sp-page-context';
import type { _ISPPageChrome } from '@ms/sp-page-chrome';
import type { _ISPPageChromeProvider } from '@ms/sp-page-chrome';
import type { ISuiteNavConfigurationData } from '@ms/sp-suite-nav';
import type { ISuiteNavManager } from '@ms/sp-suite-nav';
import type { ISuiteNavManagerConfiguration } from '@ms/sp-suite-nav';
...
import type { _SPThemeProvider } from '@ms/sp-page-chrome';
...
/* Excluded from this release type: _INavigationDataResponse */
...
/* Excluded from this release type: _ISPPageChromeProvider */
